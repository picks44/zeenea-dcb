...
const USER_MESSAGES: Partial<Record<ValidationIssue["code"], string>> = {
  ...
  "property-name-required": "Each field needs a name before publishing.",
  ...
  "quality-type-invalid": "Quality rules must be written as text descriptions.",
  "quality-dimension-invalid": "Choose a supported quality dimension.",
  "array-items":
  ...
  "sla-unit-invalid": "Use a supported time unit: days, hours, or years.",
  ...
  "sla-driver-invalid":
    "Choose a driver: regulatory, analytics, or operational.",
...
export function publishBlockUserMessage(
