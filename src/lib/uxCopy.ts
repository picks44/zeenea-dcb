...
export const WORKFLOW_PILL_NOT_IN_EXPORTED_CONTRACT =
  "Not in exported contract";
...
export const NO_CHANGES_TO_PUBLISH =
...
export const READINESS_HELPER_SCHEMA_FIELDS =
  "Add at least one table and field.";
...
export const DOCUMENTED_FIELDS_TOOLTIP =
  "Schema fields with a business description";
...
export const PUBLISH_MODAL_SUBTITLE =
  "Saves a versioned snapshot in this prototype.";
...
export const COMPARE_SELECT_TWO_VERSIONS =
  "Select two different versions to compare";

export const COMPARE_NOT_ENOUGH_VERSIONS =
...
export const COLLABORATORS_INTRO = `People who can view or edit this contract in ${APP_NAME}. Stored in the app only - not included in the exported contract file. Separate from the contract owner and governance contacts.`;
...
export const COLLABORATORS_ALREADY_INVITED =
...
export const LIFECYCLE_STATUS_TOOLTIPS: Record<LifecycleStatus, string> = {
  ...
  retired: "Withdrawn from use. Read-only; no further lifecycle actions.",
};
...
export const PROPOSED_BANNER_LEGACY = "Start drafting to edit this contract.";

export const CREATE_CONTRACT_HEADING = "Create contract";
export const CREATE_CONTRACT_SUBTITLE =
  "Pick a starting point below.";

export const CREATE_HOW_TO_START = "How would you like to start?";

export const CREATE_IMPORT_CARD_TITLE = "Import DDL";
export const CREATE_IMPORT_CARD_INTRO =
  "Paste or upload CREATE TABLE statements to pre-fill the schema.";
export const CREATE_IMPORT_CARD_CTA = "Continue with DDL import";

export const CREATE_SCRATCH_CARD_TITLE = "Start from scratch";
export const CREATE_SCRATCH_CARD_INTRO =
  "Create an empty draft contract and fill everything manually.";
export const CREATE_SCRATCH_CARD_CTA = "Create empty contract";

export const CREATE_BACK_TO_OPTIONS = "Back to creation options";
export const CREATE_DDL_STEP_TITLE = "Import DDL";
export const CREATE_DDL_FORM_INTRO =
  "Paste or upload CREATE TABLE statements. The contract is saved as proposed when you validate the import.";
...
export const FIELD_FK_INTRO = "Reference this field to another table field.";
