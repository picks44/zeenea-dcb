...
describe("P1 compliance - 55 lines (odcs-p1-reference)", () => {
  ...
  const fundAuth = (
    desc.authoritativeDefinitions as Record<string, unknown>[]
  )[0];
  const tableQuality = (orders.quality as Record<string, unknown>[])[0];
  const propQuality = (txn.quality as Record<string, unknown>[])[0];
  const tableAuth = (
    orders.authoritativeDefinitions as Record<string, unknown>[]
  )[0];
  const propAuth = (
    txn.authoritativeDefinitions as Record<string, unknown>[]
  )[0];
  ...
  const rows: P1Row[] = [
    // Schema Reference - Fundamentals (lines 1–13)
    {
      ...
      path: "apiVersion",
      run: () => expect(doc.apiVersion).toBe(ODCS_API_VERSION),
    },
    {
      line: 2,
      tab: "Schema Reference",
      section: "Fundamentals",
      path: "kind",
      run: () => expect(doc.kind).toBe(ODCS_KIND),
    },
    {
      line: 3,
      tab: "Schema Reference",
      ...
      run: () => {
        expect(doc.id).toBe(
          deriveContractId("Seller Payments v1", "p1-fixture"),
        );
    ...
    },
    {
      ...
      section: "Fundamentals",
      path: "version",
      run: () => expect(doc.version).toBe("1.1.0"),
    },
    {
      line: 5,
      tab: "Schema Reference",
    ...
    },
    {
      ...
      section: "Fundamentals",
      path: "name",
      run: () => expect(doc.name).toBe("Seller Payments v1"),
    },
    {
      line: 7,
      tab: "Schema Reference",
      section: "Fundamentals",
      path: "domain",
      run: () => expect(doc.domain).toBe("seller"),
    },
    {
      line: 8,
      tab: "Schema Reference",
    ...
    },
    {
      ...
      run: () => expect(desc.purpose).toBeTruthy(),
    },
    {
      line: 10,
      tab: "Schema Reference",
      ...
      run: () => expect(desc.limitations).toBeTruthy(),
    },
    {
      line: 11,
      tab: "Schema Reference",
      ...
      run: () => expect(desc.usage).toBeTruthy(),
    },
    {
      line: 12,
      tab: "Schema Reference",
      ...
      run: () => {
        ...
        expect(isValidFundamentalsAuthDefType(String(fundAuth.type))).toBe(
          true,
        );
      },
    },
    {
      ...
      section: "Fundamentals",
      path: "tags",
      run: () => expect(doc.tags).toEqual(["finance", "sensitive"]),
    },
    ...
    // Schema Reference - Schema (lines 14–31)
    {
      ...
      section: "Schema",
      path: "schema[].id",
      run: () => expect(orders.id).toBe("tbl-orders"),
    },
    {
      line: 15,
      tab: "Schema Reference",
      section: "Schema",
      path: "schema[].physicalName",
      run: () => expect(orders.physicalName).toBe("orders"),
    },
    {
      line: 16,
      tab: "Schema Reference",
      ...
      run: () => expect(orders.description).toBeTruthy(),
    },
    {
      line: 17,
      tab: "Schema Reference",
    ...
    },
    {
      ...
      section: "Schema",
      path: "schema[].tags",
      run: () => expect(orders.tags).toEqual(["Core"]),
    },
    {
      line: 19,
      tab: "Schema Reference",
    ...
    },
    {
      ...
      run: () => expect(txn.id).toBe("tbl_orders_txn_ref_dt_prop"),
    },
    {
      line: 21,
      tab: "Schema Reference",
      section: "Schema property",
      path: "schema[].properties[].description",
      run: () => expect(txn.description).toBeTruthy(),
    },
    {
      line: 22,
      tab: "Schema Reference",
      section: "Schema property",
      path: "schema[].properties[].physicalType",
      run: () => expect(txn.physicalType).toBe("DATE"),
    },
    {
      line: 23,
      tab: "Schema Reference",
      section: "Schema property",
      path: "schema[].properties[].required",
      run: () => expect(txn.required).toBe(true),
    },
    {
      line: 24,
      tab: "Schema Reference",
    ...
    },
    {
      ...
      tab: "Schema Reference",
      section: "Schema property",
      path: "schema[].properties[].physicalName",
      run: () => expect(txn.physicalName).toBe("TXN_REF_DT"),
    },
    {
      line: 27,
      tab: "Schema Reference",
      section: "Schema property",
      path: "schema[].properties[].examples",
      run: () => expect(txn.examples).toEqual(["2022-10-03"]),
    },
    {
      line: 28,
      tab: "Schema Reference",
      section: "Schema property",
      path: "schema[].properties[].items",
      run: () =>
        expect((tagsCol.items as Record<string, unknown>).logicalType).toBe(
          "string",
        ),
    },
    {
    ...
    },
    {
      ...
      tab: "Schema Reference",
      section: "Schema property",
      path: "schema[].properties[].tags",
      run: () => expect(txn.tags).toEqual(["pii"]),
    },
    {
      line: 31,
      tab: "Schema Reference",
    ...
    },
    {
      ...
      tab: "Schema Reference",
      section: "SLA",
      path: "slaProperties[].value",
      run: () => expect(sla.value).toBe("4"),
    },
    {
      line: 34,
      tab: "Schema Reference",
      section: "SLA",
      path: "slaProperties[].unit",
      run: () => {
        expect(sla.unit).toBe("h");
        expect(isValidSlaUnit("h")).toBe(true);
      },
    },
    {
      line: 35,
      tab: "Schema Reference",
      section: "SLA",
      path: "slaProperties[].element",
      run: () => expect(sla.element).toBe("orders.TXN_REF_DT"),
    },
    {
      line: 36,
      tab: "Schema Reference",
      section: "SLA",
      path: "slaProperties[].driver",
      run: () => {
        expect(sla.driver).toBe("regulatory");
        expect(SLA_DRIVERS).toContain("regulatory");
      },
    },
    {
      line: 37,
      tab: "Schema Reference",
      section: "SLA",
      path: "slaProperties[].description",
      run: () => expect(sla.description).toBeTruthy(),
    },
    ...
    // Roles (lines 38–41)
    {
      ...
      section: "Roles",
      path: "roles",
      run: () => expect(doc.roles).toHaveLength(1),
    },
    {
      line: 39,
      tab: "Schema Reference",
      section: "Roles",
      path: "roles[].role",
      run: () => expect(role.role).toBe("microstrategy_user_opr"),
    },
    {
      line: 40,
      tab: "Schema Reference",
      section: "Roles",
      path: "roles[].access",
      run: () => expect(role.access).toBe("read"),
    },
    {
      line: 41,
      tab: "Schema Reference",
      ...
      run: () => expect(role.description).toBeTruthy(),
    },
    ...
    // Shared Components (lines 62–75)
    {
      ...
      path: "[].id",
      run: () => expect(propQuality.id).toBe("order_id_no_nulls"),
    },
    {
      line: 63,
      tab: "Shared Components",
      section: "Quality rule",
      path: "[].name",
      run: () => expect(propQuality.name).toBe("No nulls"),
    },
    {
      line: 64,
      tab: "Shared Components",
      section: "Quality rule",
      path: "[].description",
      run: () => expect(propQuality.description).toBeTruthy(),
    },
    {
      line: 65,
      tab: "Shared Components",
      section: "Quality rule",
      path: "[].type",
      run: () => expect(propQuality.type).toBe("text"),
    },
    {
      line: 66,
      tab: "Shared Components",
    ...
    },
    {
      ...
      section: "Quality rule",
      path: "[].severity",
      run: () => expect(propQuality.severity).toBe("high"),
    },
    {
      line: 68,
      tab: "Shared Components",
      section: "Quality rule",
      path: "[].businessImpact",
      run: () => expect(propQuality.businessImpact).toBeTruthy(),
    },
    {
      line: 69,
      tab: "Shared Components",
      ...
      path: "[].url",
      run: () => expect(fundAuth.url).toBeTruthy(),
    },
    {
      line: 70,
      tab: "Shared Components",
    ...
    },
    {
      ...
      section: "Authoritative definition",
      path: "[].description",
      run: () => expect(fundAuth.description).toBeTruthy(),
    },
    {
      line: 72,
      tab: "Shared Components",
      ...
      path: "[].property",
      run: () => {
        expect(custom.property).toBe("dataSteward");
    ...
    },
    {
      ...
      section: "Custom property",
      path: "[].value",
      run: () => expect(custom.value).toBeTruthy(),
    },
    {
      line: 74,
      tab: "Shared Components",
      section: "Custom property",
      path: "[].description",
      run: () => expect(custom.description).toBeTruthy(),
    },
    {
      line: 75,
      tab: "Shared Components",
      section: "Tag",
      path: "[]",
      run: () => expect(doc.tags).toContain("finance"),
    },
  ];
